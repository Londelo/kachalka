...
import { createSqliteRoutineRepository } from './routine-repo-impl'
...
describe('createSqliteRoutineRepository', () => {
  ...
  it('creates a user and exercise for testing', () => {
    ...
    expect(exercise.lastInsertRowid).toBeGreaterThan(0)
  })
